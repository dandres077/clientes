            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ url ('admin/cities/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tr class="gradeX">
                    ...
                    @can('cities.active')                   
                    @if ($cities->status==1)
                        <form method="post" action="{{ url('admin/cities/'.$cities->id.'/inactive')}}">
                            {{ csrf_field() }}
                    ...
                    @else
                        <form method="post" action="{{ url('admin/cities/'.$cities->id.'/active')}}">
                            {{ csrf_field() }}
                    ...
                    <td>
                    @can('cities.edit')
                        <a href="{{ url('admin/cities/'.$cities->id.'/edit')}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit">
